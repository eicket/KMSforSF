...
#define MODBITS_BN158 MBITS_BN158
#define TBITS_BN158 (MBITS_BN158%BASEBITS_B160_56)              /**< Number of active bits in top word */
#define TMASK_BN158 (((chunk)1<<TBITS_BN158)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BN158 (((sign32)1<<MAXXES_BN158)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
...
extern const B160_56::BIG SQRTm3;      /**< Square root of -3 */
extern const B160_56::BIG CRu;    /**< Cube Root of Unity */
...
extern const B160_56::BIG TWK; /**< Tweak for square roots, pre-calculated from field norm */
//#define FUSED_MODMUL
//#define DEBUG_REDUCE
