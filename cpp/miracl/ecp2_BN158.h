...
//    int inf; /**< Infinity Flag */
    BN158::FP2 x;   /**< x-coordinate of point */
    BN158::FP2 y;   /**< y-coordinate of point */
    BN158::FP2 z;   /**< z-coordinate of point */
} ECP2;
...
extern const B160_56::BIG CURVE_Bnx;   /**< Elliptic curve parameter */
 ...
 */
extern int ECP2_get(BN158::FP2 *x, BN158::FP2 *y, ECP2 *P);
 ...
 */
extern void ECP2_rhs(BN158::FP2 *r, BN158::FP2 *x);
 ...
 */
extern int ECP2_set(ECP2 *P, BN158::FP2 *x, BN158::FP2 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_setx(ECP2 *P, BN158::FP2 *x, int s);
 ...
 */
extern void ECP2_mul(ECP2 *P, B160_56::BIG b);
 ...
 */
extern void ECP2_frob(ECP2 *P, BN158::FP2 *f);
 ...
 */
extern void ECP2_mul4(ECP2 *P, ECP2 *Q, B160_56::BIG *b);
 ...
 */
extern void ECP2_map2point(ECP2 *Q, BN158::FP2 *x);
 ...
 */
extern void ECP2_hap2point(ECP2 *Q, B160_56::BIG  x);
